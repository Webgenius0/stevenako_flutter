...
class GetAllMesageListModel {
  bool? success;
  String? message;
  Data? data;
  int? code;

  GetAllMesageListModel({
    this.success,
    this.message,
    this.data,
    this.code,
  ...
  GetAllMesageListModel copyWith({
    bool? success,
    String? message,
    Data? data,
    int? code,
  ...
  factory GetAllMesageListModel.fromRawJson(String str) => GetAllMesageListModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllMesageListModel.fromJson(Map<String, dynamic> json) => GetAllMesageListModel(
