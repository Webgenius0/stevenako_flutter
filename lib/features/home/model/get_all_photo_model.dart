...
class GetAllPhotoModel {
  ...
  factory GetAllPhotoModel.fromRawJson(String str) => GetAllPhotoModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllPhotoModel.fromJson(Map<String, dynamic> json) => GetAllPhotoModel(
